...
import { RiEditLine, RiArrowLeftLine, RiFileTextLine, RiTimeLine, RiBarChartBoxLine, RiAddLine } from "@remixicon/react"
...
export default async function TrainerAssessmentDetailPage({
  params,
}: {
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link href={`/trainer/assessments/${assessment.id}/edit`}>
            <Button>
      ...
      <Tabs defaultValue="questions" className="w-full">
        <TabsList className="grid w-full max-w-150 grid-cols-2">
