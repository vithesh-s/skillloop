...
export default async function ManagerTNAPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Team TNA Reports</h1>
          <p className="text-muted-foreground mt-1">
            Skill gap analysis and training needs for your team
          </p>
        </div>
        <Button>
...
async function TeamTNAContent() {
  // This action now automatically scopes to manager's team if caller is Manager
    ...
    <>
      ...
      <Tabs defaultValue="overview" className="space-y-4">
        <TabsList>
          ...
          <TabsTrigger value="employees">Team Members ({employeeTNAs.length})</TabsTrigger>
        </TabsList>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Average gap scores</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Skills needing most attention in your team</CardDescription>
              </CardHeader>
              <CardContent>
