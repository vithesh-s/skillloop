...
export default function TNAError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    ...
    console.error('TNA page error:', error)
  }, [error])
    ...
    <div className="container mx-auto p-6">
      <Card className="max-w-2xl mx-auto mt-12">
        <CardContent className="pt-12 pb-12 text-center">
          ...
          <h2 className="text-2xl font-bold mb-2">Failed to Load TNA Report</h2>
          <p className="text-muted-foreground mb-6 max-w-md mx-auto">
            We encountered an error while generating the Training Need Analysis report. 
